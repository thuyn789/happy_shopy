...
import 'package:happy_shopy/board_messages/chat_message.dart';
...
class _ChatScreenState extends State<ChatScreen> with TickerProviderStateMixin {
  ...
  Widget _messageStreamWidget() {
    return StreamBuilder<QuerySnapshot>(
        stream: DBServices().messageStream(widget.topic),
  ...
  Future<void> _sendMessageToDb(String message) async {
    DocumentSnapshot userData = await DBServices().retrieveUserData();
